(function () {
  ...
  describe('Admin Comments List Controller Tests', function () {
    // Initialize global variables
    var CommentsAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _CommentsService_) {
      ...
      $httpBackend.whenGET('/modules/comments/client/views/list-comments.client.view.html').respond(200, '');
      ...
      CommentsAdminListController = $controller('CommentsAdminListController as vm', {
        $scope: $scope
      });
