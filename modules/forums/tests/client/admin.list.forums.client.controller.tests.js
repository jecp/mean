(function () {
  ...
  describe('Admin Forums List Controller Tests', function () {
    // Initialize global variables
    var ForumsAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _ForumsService_) {
      ...
      $httpBackend.whenGET('/modules/forums/client/views/list-forums.client.view.html').respond(200, '');
      ...
      ForumsAdminListController = $controller('ForumsAdminListController as vm', {
        $scope: $scope
      });
